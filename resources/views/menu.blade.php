                    ...
                    <div class="container-fluid">
                            ...
                            <div class="d-flex justify-content-start">
                                <div class="col-6 me-2">
                                    ...
                                    <input type="text" class="form-control" id="menu_rutasNuevo"
                                        name="menu_rutasNuevo" tabindex="1"
                                        placeholder="Inserta el nombre de la ruta" value="" required>
                                    </div>
                                    <div class="col-6 me-2">
                                        <label for="title" class="form-label">Titulo de la ruta</label>
                                        <input type="text" class="form-control" id="titleNuevo"
                                            name="titleNuevo" tabindex="1"
                    ...
                    <form>
                        ...
                        <div class="d-flex justify-content-start">
                            ...
                            <div class="col-6 me-2">
                                ...
                                <input type="text" class="form-control" id="menu_rutasEdit"
                                    name="menu_rutasEdit" tabindex="1"
                                    placeholder="Inserta el nombre de la ruta" value="" required>
                                </div>
                                <div class="col-6 me-2">
                                    <label for="title" class="form-label">Titulo de la ruta</label>
                                    <input type="text" class="form-control" id="titleEdit"
                                        name="titleEdit" tabindex="1"
                                        placeholder="Inserta el titulo de la ruta" value="" required>
                                </div>
                        </div>
                </form>
...
@section('js')
    ...
    <script>
        ...
        $(document).on('click', '.btnconsultamenu', function() {
            ...
            $mar_id = $datos['mar_id'];
            $(location).prop('href', 'http://127.0.0.1:8000/menu_show/' + $mar_id);
        });
